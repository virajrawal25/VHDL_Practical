...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/free_running_counter/free_running_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log free_running_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source free_running_counter.tcl
