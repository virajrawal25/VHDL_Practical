...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/VHDL/Practical 1/Basic_gates/and_gate_3ip/and_gate_3ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_gate_3ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_gate_3ip.tcl
