...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/VHDL/Practical 1/Basic_gates/or_gate_3ip/or_gate_3ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or_gate_3ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or_gate_3ip.tcl
