...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/basicgates1/and_gate/exor_gate/exor_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exor_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exor_gate.tcl
