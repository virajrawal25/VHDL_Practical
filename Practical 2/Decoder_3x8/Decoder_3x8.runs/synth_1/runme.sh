...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/Practical 2/Decoder_3x8/Decoder_3x8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_3x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder_3x8.tcl
