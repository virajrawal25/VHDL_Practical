...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/Practical 2/and_4input/and_4input.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_4input.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_4input.tcl
