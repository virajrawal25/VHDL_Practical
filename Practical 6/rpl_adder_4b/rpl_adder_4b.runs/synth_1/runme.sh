...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/Practical 6/rpl_adder_4b/rpl_adder_4b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rpl_adder_4b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rpl_adder_4b.tcl
