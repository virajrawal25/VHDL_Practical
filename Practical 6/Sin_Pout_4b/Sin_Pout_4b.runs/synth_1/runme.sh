...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/Practical 6/Sin_Pout_4b/Sin_Pout_4b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sin_Pout_4b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sin_Pout_4b.tcl
