...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/Practical 6/Sin_Pout_4b/Sin_Pout_4b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sin_Pout_4b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sin_Pout_4b.tcl -notrace
