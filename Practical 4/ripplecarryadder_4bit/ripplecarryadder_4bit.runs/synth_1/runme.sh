...
HD_PWD='F:/A_viraj drive/AMtech/HDL/Practical/Practical 4/ripplecarryadder_4bit/ripplecarryadder_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripplecarryadder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripplecarryadder_4bit.tcl
